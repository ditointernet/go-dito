...
func TestError(t *testing.T) {
	...
	tt := []struct {
	...
	}{
		{
			...
			expectedLog: `{"timestamp":"2020-12-01T12:00:00Z","level":"ERROR","message":"random error","attributes":{"code":"UNKNOWN","kind":"UNEXPECTED"}}`,
		},
		{
			desc:        "should log when LogLevel is INFO",
			ctx:         ctx,
		...
		},
		{
			...
			err:         errors.New("random error"),
			attrs:       LogAttributeSet{"attr1": true},
			expectedLog: `{"timestamp":"2020-12-01T12:00:00Z","level":"ERROR","message":"random error","attributes":{"attr1":"value1","code":"UNKNOWN","kind":"UNEXPECTED"}}`,
		},
	}
...
func TestCritical(t *testing.T) {
	...
	tt := []struct {
	...
	}{
		{
			...
			level:       "DEBUG",
			err:         errors.New("random error"),
			expectedLog: `{"timestamp":"2020-12-01T12:00:00Z","level":"CRITICAL","message":"random error","attributes":{"code":"UNKNOWN","kind":"UNEXPECTED"}}`,
		},
		{
			desc:        "should log when LogLevel is INFO",
			ctx:         ctx,
		...
		},
		{
			...
			err:         errors.New("random error"),
			attrs:       LogAttributeSet{"attr1": true},
			expectedLog: `{"timestamp":"2020-12-01T12:00:00Z","level":"CRITICAL","message":"random error","attributes":{"attr1":"value1","code":"UNKNOWN","kind":"UNEXPECTED"}}`,
		},
	}
